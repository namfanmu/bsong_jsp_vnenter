...
<div class="content_resize">
  ...
  %>
    <div class="article">
      <h2><a href="<%=request.getContextPath()%>/song?id=<%=song.getId() %>" title="<%=song.getName() %>"><%=song.getName() %></a></h2>
      ...
      <div class="post_content">
        ...
        <p class="spec"><a href="<%=request.getContextPath()%>/song?id=<%=song.getId() %>" class="rm">Chi tiết &raquo;</a></p>
      </div>
      <div class="clr"></div>
    </div>
    <%
        ...
        <div class="col-sm-6" style="text-align: left;">
            <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                <ul class="pagination">
                    ...
                    %>
                    <li class="paginate_button<%=active %>" aria-controls="dataTables-example" tabindex="0"><a href="<%=request.getContextPath()%>/index?page=<%=i%>"><%=i %></a></li>
                    <%
                    	}
                    %>
